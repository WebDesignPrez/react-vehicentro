...
function FormContactFicha(props) {
  ...
  const validateCon = (e) => {
    if (e === "" || e === "Concesionario") return true;
    else return false;
  };
  ...
  function handleSumbit(e) {
    ...
    if (
      ...
      !validateTel(e.target[3].value) &&
      !validateCed(e.target[4].value) &&
      !validateCon(e.target[5].value)
    ) {
      console.log("Valid");
  ...
  const serieT7H = [
    "T7H 390 / 28 TON",
    "T7H 340 / 28 TON",
    "T7H 390 / 28 TON con retardador",
    "T7H 390 / 42 TON",
    "T7H 430 / 45 TON",
  ];
  const serieC7H = [
    "C7H 1256 / 20 TON",
    "C7H 1256 / 20 TON con Catalinas",
    "C7H 540 / 48 TON",
    "C7H 540 / 48 TON con Catalinas",
  ...
  const excavadora = ["SWE210", "SWE370E", "SWE600"];
  const furgoneta = ["M70L"];
  const miniCargadora = ["SWL3220"];
  const autos = ["U70PRO", "U70-FULL", "U70PROAMT"];
  ...
  return (
    <div className="modalForm">
      <span className="closeBtnForm" onClick={closeBtn}>
        <img src="https://vehicentro.com/images/close-icon.png" alt="close" />
      </span>
      <div className="form-box">
        ...
        <form action={url} method="post" onSubmit={(ev) => handleSumbit(ev)}>
          <div className="field1">
            <label>
              {" "}
              Déjanos tus datos y uno de nuestros asesores se contactará contigo
            </label>
            ...
            <div className="input-group">
              <span className="userIcon">
                <img src={urlMedia + "address-card-solid.png"} />
              </span>
              <input
                placeholder=""
                name="ciudad"
            ...
            <label className="input_title">
              *Escoge tu concesionario más cercano
            </label>
            <div className="input-group">
              <span className="userIcon">
              ...
              <select
                ...
                value={escoge_tu_concesionario_mas_cercano}
              >
                <option value="Concesionario">Concesionario</option>
                <option value="Ambato - Av. Indoamérica Sector Izamba">
                  Ambato - Av. Indoamérica Sector Izamba
                </option>
                <option value="Ambato - Av. Guaytambos Sector Ficoa">
                  Ambato - Av. Guaytambos Sector Ficoa
                </option>
            ...
            <div className="input-group">
              ...
              <select
                name="modelo_sinotruk"
                onChange={(e) => {
                  handleChangeSerieCamion(e);
                }}
                value={camionSerie}
              >
                {options}
