...
function FormNewProductos() {
  ...
  const handleSumbit = (e) => {
    ...
    switch (producto) {
      case 'Autos Sinotruk':
        url = "https://bdc.vehicentro.com:9443/ords/ws_vehicentro/api/conexiones/wordpress/CPCLIVLAND";
        break;
      case 'Camiones Sinotruk':
        url = "https://bdc.vehicentro.com:9443/ords/ws_vehicentro/api/conexiones/wordpress/CPCPESLAND";
        break;
      case 'Maquinaria Sunward':
        url = "https://bdc.vehicentro.com:9443/ords/ws_vehicentro/api/conexiones/wordpress/CPCMAQLAND";
        break;
      default:
        url = "";
    }
          ...
          <form onSubmit={handleSumbit}>
            <div className="field1">
              ...
              <div className="input-group">
                <input name="nombre_y_apellido" type="text" onBlur={handleFocus} onChange={handleChangeNombre} value={nombre} />
              </div>

              <label className="input_title">EMAIL*</label>
              <div className="input-group">
                <input name="email" type="text" onBlur={handleFocusEmail} onChange={handleChangeEmail} value={email} />
              </div>

              <label className="input_title">CELULAR*</label>
              <div className="input-group">
                <input name="celular" type="text" onBlur={handleFocusCelular} onChange={handleChangeCelular} value={celular} />
              </div>

              <label className="input_title">PRODUCTO*</label>
              <div className="input-group">
                <select name="producto" onChange={handleChangeProducto} value={producto}>
            ...
            <label>
              <a href="https://www.vehicentro.com/" target="_blank" className="linknew">www.vehicentro.com</a>
            </label>
