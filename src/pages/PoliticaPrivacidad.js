      ...
      <div className="privaty">
        <div className="texto">
          ...
          <div className="espacioText">
            ...
            <p>●	Seguridad de las instalaciones de las instalaciones de Vehicentro (cuando aplique).</p>
            <p>●  Datos necesarios para cumplimiento de prevención de lavado de activos.	</p>
            <p>●	Transferir datos a entidades bancarias, financieras, aseguradoras, brókers, etc. en caso de ser necesario para cumplir con la oferta del vehículo o el servicio.</p>
          </div>
          ...
          <br />
          <p>
            Para Clientes, la información personal que pedimos puede incluir su dirección de correo electrónico, nombre y apellido, domicilio, nacionalidad, número de teléfono, cédula o RUC (solo para persona natural con RUC). <br />
            En caso de adquirir un bien o servicio con Vehicentro, será necesario recopilar información sensible necesaria para prevenir el lavado de activos como su pasado judicial como lo manda la UAFE.<br />
            Para servicio de taller o mecánica y repuestos, además de los datos anteriormente mencionados puede incluir la matrícula del vehículo.<br />
            Para procesar su solicitud de crédito o financiación, es posible que también se le pida acceder a su historial crediticio o buró crédito, cuentas bancarias, tarjetas de crédito, activos, pasivos, patrimonio, datos personales del cónyuge y/o garante y otros datos relevantes.<br />
            Dentro de las instalaciones de Vehicentro se podrán recopilar datos biométricos como su rostro a través de cámaras de videovigilancia para salvaguardar la seguridad de la empresa.<br />
            Además, se podrá transferir los datos del titular a otro responsable para que sea tratado en relación con seguros, solicitudes de crédito y prospección de clientes.<br />
            <br />
          </p>
          ...
          <div className="espacioText">
            ...
            <p>●	Datos sensibles como el sexo o identificación de género se tratarán en la función de cumplimiento de la empresa para cumplir requerimientos de la UAFE.</p>
          </div>
          ...
          <br />
          <p>Vehicentro podrá compartir su información personal con terceros como lo son empresas filiales o socios comerciales, además debidamente autorizados:</p>
          <br />
          ...
          <div className="espacioText">
            ...
            <p>● 	Proveedores de Seguros y brókers aprobadas por la Superintendencia de Bancos o la Superintendencia de Economía Popular y Solidaria.</p>
            <p>● 	Entidades Crediticias y Financieras como bancos, cooperativas y sociedades financieras aprobadas por la Superintendencia de Bancos o la Superintendencia de Economía Popular y Solidaria.</p>
            <p>● 	Servicios de Marketing y Analítica de Datos de RRSS	</p>
            <p>● 	Asesoría legal	</p>
            <p>● 	Servicios de Distribución y Mensajería (Servientrega y otros)	</p>
          </div>
          ...
          <p>
            El titular o interesado otorga su consentimiento de forma libre, voluntaria e inequívoca, el cual será recabado mediante la aceptación de manera verbal, física, a través de redes sociales, mensajería instantánea, correos electrónicos, página web, formularios o registros de clientes.<br />
            En función de su interés legítimo, Vehicentro analizará las preferencias de los titulares o interesados para ofrecer productos y servicios que se consideran de su interés.<br />
            Los datos del titular serán conservados única y exclusivamente por el tiempo necesario especificado en la cláusula correspondiente de esta política. Luego de este período los datos se eliminarán o bloquearán conforme a los mecanismos, herramientas y estrategias implementados por Vehicentro. <br />
            El titular podrá revocar su consentimiento para el uso y tratamiento de sus datos en cualquier momento, siempre que no exista algún otro requerimiento legal que lo impida. <br />
          </p>
          ...
          <div className="espacioText">
            <p>●	Acceso: el titular o interesado puede conocer qué datos personales son tratados.</p>
            <p>●	Rectificación y actualización: el titular o interesado puede modificar o actualizar sus datos personales.</p>
            <p>●  Eliminación: el titular o interesado puede solicitar la supresión de sus datos personales cuando:  </p>
            <div className="espacioText">
            ...
            <p>Todo ello siempre que no se contraponga con cualquier medida legal estipulada por el Estado Ecuatoriano que imposibilite el ejercicio a ese derecho o el titular no tenga una obligación contractual con Vehicentro.</p>

            <p>●  Oposición: el titular o interesado puede oponerse o negarse al uso de sus datos personales cuando:</p>
            <div className="espacioText">
          ...
          <p>Vehicentro no conservará los datos más tiempo del necesario, basándose en la necesidad del tratamiento y con los tiempos previstos por los organismos de control o en casos en los que no haya un fundamento legal de un organismo de control (10 años por control de lavado de activos), el tiempo no será superior a 3 años por procedimientos internos y trazabilidad de la empresa. Pasado esos tiempos los datos serán eliminados o suspendidos su tratamiento según los procedimientos implementados en Vehicentro.</p>
          ...
          <p>
            El Oficial de Protección de Datos Personales es la figura encargada de supervisar el cumplimiento de la LOPDP a fin de garantizar la protección de los datos personales que el titular o interesado facilita a Vehicentro. <br />
            En caso de requerir contactar con Vehicentro para ejercer cualquier derecho del titular o para el acompañamiento en la revocatoria o modificaciones del consentimiento lo puede realizar mediante el correo <a href="mailto:privacidad@vehicentro.com">privacidad@vehicentro.com</a>, o acercarse a Vehicentro Matriz, Av. Indoamérica Km 3 1/2 Vía a Quito o mediante contacto telefónico de atención al cliente + 03 2 994740 ext. 1017.
          </p>
          ...
          <p>
            La actualización al presente contenido será notificada a través del sitio web de Vehicentro: <a href="https://vehicentro.com/">https://vehicentro.com/</a> <br />
            Última Versión: 18/11/2023
          </p>
