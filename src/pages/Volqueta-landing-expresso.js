...
function Camion() {
    ...
    switch ((useParams("id").id)) {
        ...
        case "volqueta-c7h-540":
            ...
            nombreSerie = "Especiales"
            bdc = "https://bdc.vehicentro.com:9443/ords/ws_vehicentro/api/conexiones/wordpress/LDEXPVOLQUETA540"
            images = [
        ...
        case "volqueta-t7h-430-20m3":
            ...
            nombreSerie = "Especiales"
            bdc = "https://bdc.vehicentro.com:9443/ords/ws_vehicentro/api/conexiones/wordpress/LDEXPVOLQUETAT7H54020M3"
            images = [
