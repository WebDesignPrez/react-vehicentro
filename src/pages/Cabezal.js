...
function Camion() {
  ...
  switch (useParams("id").id) {
    ...
    case "cabezal-t5g-4187":
      ...
      mercadoObjetivo =
        "Porta contenedores, niñera, transporte de vehículos, tanquero de combustible, aceite, alimentos, agua, etc carga seca, carga refrigerada, carga en general";
      fortalezas =
        "Motor man de alta tecnologia, gran experiencia a nivel mundial. Unificación de partes y componentes al estar disponible en otros modelos de la marca";
      bdc =
        "https://bdc.vehicentro.com:9443/ords/ws_vehicentro/api/conexiones/wordpress/WEB24TT5G4187";
      images = [
      ...
      motor =
        urlMedia +
        "24-toneladas/motor-sinotruk-de-camion-de-24-toneladas-ecuador.webp";
      ...
      caracteristicas = [
        ...
        urlMedia +
          "24-toneladas/camion-de-24-toneladas-freno-a-las-valvulas.webp",
        urlMedia + "24-toneladas/inyeccion.webp",
      ];
      cabina =
        urlMedia +
        "24-toneladas/cabina-de-camion-de-24-toneladas-sinotruk.webp";
      ...
      contenedorMarcas = (
        <div className="boxRightHeader  half" style={{ width: "100 %" }}>
          <img
            ...
            height="750"
            className="slideMain"
            alt={`Marcas ${nombreBusqueda}, ${nombreBusqueda2}`}
            title={`${nombreBusqueda}, ${nombreBusqueda2}`}
          />
        </div>
      );

      contenedorVidaUtil = (
        <div className="ajustetextovidautil">
          <p>Disponible en AMT</p>
        </div>
      );
    ...
    case "cabezal-t7h-390-28-toneladas":
      ...
      fortalezas =
        "Tiene conexión al ABS de la carreta, modo de conducción eco, medio y potente";
      bdc =
        "https://bdc.vehicentro.com:9443/ords/ws_vehicentro/api/conexiones/wordpress/Web28TT7H390";
      images = [urlMedia + "persNuevo/28_TON.jpg"];
      textoMotor1 = "390 HP";
      ...
      motor =
        urlMedia +
        "28-toneladas/motor-sinotruk-de-camion-de-28-toneladas-ecuador.webp";
      ...
      caracteristicas = [
        ...
        urlMedia +
          "28-toneladas/camion-de-28-toneladas-freno-a-las-valvulas.webp",
        urlMedia + "28-toneladas/inyeccion.webp",
      ];
      cabina =
        urlMedia +
        "28-toneladas/cabina-de-camion-de-28-toneladas-sinotruk.webp";
      marcas = urlMedia + "marcas-vehicentro.webp";
      internas1 = [
      ...
      contenedorMarcas = (
        <div className="boxRightHeader  half" style={{ width: "100 %" }}>
          <img
            ...
            className="slideMain"
            alt={`Marcas ${nombreBusqueda}, ${nombreBusqueda2}`}
            title={`tecnologias ${nombreBusqueda}`}
          />
        </div>
      );
    ...
    case "cabezal-t7h-340-28-toneladas":
      ...
      fortalezas =
        "Tiene conexión al ABS de la carreta, modo de conducción eco, medio y potente";
      bdc =
        "https://bdc.vehicentro.com:9443/ords/ws_vehicentro/api/conexiones/wordpress/WEBVH28TONWEICHAI";
      images = [urlMedia + "persNuevo/28_TON_W.jpg"];
      textoMotor1 = "340 HP";
      ...
      caracteristicas = [
        urlMedia +
          "28-toneladas-retardador/camion-de-28-toneladas-potencia-390hp.webp",
        urlMedia + "24-toneladas/camion-de-24-toneladas-cilindraje.webp",
        urlMedia +
          "24-toneladas/camion-de-24-toneladas-freno-a-las-valvulas.webp",
    ...
    case "cabezal-28-toneladas-retardador":
      ...
      bdc =
        "https://bdc.vehicentro.com:9443/ords/ws_vehicentro/api/conexiones/wordpress/Web28TT7H390";
      images = [urlMedia + "persNuevo/28_TON_R.jpg"];
      textoMotor1 = "390 HP";
      textoMotor2 = "Modelo T7H-390";
      textoMotor3 = "Ficha técnica";
      ...
      motor =
        urlMedia +
        "28-toneladas-retardador/motor-sinotruk-de-camion-de-28-toneladas-ecuador.webp";
      ...
      caracteristicas = [
        urlMedia +
          "28-toneladas-retardador/camion-de-28-toneladas-potencia-390hp.webp",
        urlMedia +
          "28-toneladas-retardador/camion-de-28-toneladas-cilindraje.webp",
        urlMedia +
          "28-toneladas-retardador/camion-de-28-toneladas-freno-a-las-valvulas.webp",
        urlMedia + "28-toneladas-retardador/inyeccion.webp",
      ];
      cabina =
        urlMedia +
        "28-toneladas-retardador/cabina-de-camion-de-28-toneladas-sinotruk.webp";
      marcas = urlMedia + "marcas-vehicentro.webp";
      internas1 = [
    ...
    case "cabezal-t7h-390-42-toneladas":
      ...
      fortalezas =
        "Frenos de tambor, accionado 100% de aire de doble circuito a todas las ruedas con ABS";
      bdc =
        "https://bdc.vehicentro.com:9443/ords/ws_vehicentro/api/conexiones/wordpress/WEB42TT7H390";
      images = [urlMedia + "persNuevo/42_TON.jpg"];
      textoMotor1 = "390 HP";
      textoMotor2 = "Modelo T7H-390";
      textoMotor3 = "Ficha técnica";
      ...
      motor =
        urlMedia +
        "42-toneladas/motor-sinotruk-de-camion-de-42-toneladas-ecuador.webp";
      ...
      caracteristicas = [
        ...
        urlMedia +
          "42-toneladas/camion-de-42-toneladas-freno-a-las-valvulas.webp",
        urlMedia + "42-toneladas/inyeccion.webp",
      ];
      cabina =
        urlMedia +
        "42-toneladas/cabina-de-camion-de-42-toneladas-sinotruk.webp";
      marcas = urlMedia + "marcas-vehicentro.webp";
      internas1 = [
    ...
    case "cabezal-t7h-430-45-toneladas":
      ...
      mercadoObjetivo = "Transporte pesado en general";
      fortalezas =
        "Frenos de tambor, accionado 100% de aire de doble circuito a todas las ruedas con ABS, freno al escape, con válvula de control electro neumático y freno a las válvulas (EVB)";
      bdc =
        "https://bdc.vehicentro.com:9443/ords/ws_vehicentro/api/conexiones/wordpress/WEB45TT7H430";
      images = [urlMedia + "persNuevo/45_TON.jpg"];
      textoMotor1 = "430 HP";
      ...
      motor =
        urlMedia +
        "45-toneladas/motor-sinotruk-de-camion-de-45-toneladas-ecuador.webp";
      ...
      caracteristicas = [
        ...
        urlMedia +
          "45-toneladas/camion-de-45-toneladas-freno-a-las-valvulas.webp",
        urlMedia + "45-toneladas/inyeccion.webp",
      ];
      cabina =
        urlMedia +
        "45-toneladas/cabina-de-camion-de-45-toneladas-sinotruk.webp";
      marcas = urlMedia + "marcas-vehicentro.webp";
      internas1 = [
    ...
    case "cabezal-c7h-540":
      ...
      bdc =
        "https://bdc.vehicentro.com:9443/ords/ws_vehicentro/api/conexiones/wordpress/LDCO48TON";
      images = [urlMedia + "48New/48_TON.jpg"];
      textoMotor1 = "540 HP";
      ...
      motor =
        urlMedia +
        "48-toneladas/motor-sinotruk-de-camion-de-48-toneladas-ecuador.webp";
      ...
      caracteristicas = [
        ...
        urlMedia +
          "48-toneladas/camion-de-48-toneladas-freno-a-las-valvulas.webp",
    ...
    case "cabezal-c7h-540-catalinas-48-toneladas-nueva-version":
      ...
      mercadoObjetivo = "Transporte pesado en general";
      fortalezas =
        "Bajo consumo de combustible, doble tanque de aluminio, aros de alcoa, chasis reforzado, capacidad eje posterior, mayor comodidad cabina, camarote, full extras, Catalinas";
      bdc =
        "https://bdc.vehicentro.com:9443/ords/ws_vehicentro/api/conexiones/wordpress/WEB48TC7H540CATNEW";
      images = [
      ...
      motor =
        urlMedia +
        "48-toneladas-catalinas/motor-sinotruk-de-camion-de-48-toneladas-ecuador.webp";
      garantia = urlMedia + "48-toneladas-catalinas/5-anos-de-garantia.webp";
      tecnologia = urlMedia + "alemania_negro.webp";
      caracteristicas = [
        urlMedia +
          "48-toneladas-catalinas/camion-de-48-toneladas-potencia-540hp.webp",
        urlMedia +
          "48-toneladas-catalinas/camion-de-48-toneladas-cilindraje.webp",
        urlMedia +
          "48-toneladas-catalinas/camion-de-48-toneladas-freno-a-las-valvulas.webp",
    ...
    case "cabezal-c7h-540-catalinas-48-toneladas":
      ...
      fortalezas =
        "Bajo consumo de combustible, doble tanque de aluminio, aros de alcoa, chasis reforzado, capacidad eje posterior, mayor comodidad cabina, camarote, full extras, Catalinas";
      bdc =
        "https://bdc.vehicentro.com:9443/ords/ws_vehicentro/api/conexiones/wordpress/WEB48TC7H540OFFROAD";
      images = [urlMedia + "portadasSinSorteo/48_TON_C_3_4.webp"];
      textoMotor1 = "540 HP";
      textoMotor2 = "Modelo C7H-540";
      textoMotor3 = "Ficha técnica";
      ...
      cabina =
        urlMedia +
        "48-toneladas-catalinas/cabina-de-camion-de-48-toneladas-sinotruk.webp";
      marcas = urlMedia + "48-toneladas-catalinas/marcas-vehicentro.webp";
      internas1 = [
    ...
    case "cabezal-48-max":
      ...
      fortalezas =
        "Tiene conexión al ABS de la carreta, modo de conducción eco, medio y potente";
      bdc =
        "https://bdc.vehicentro.com:9443/ords/ws_vehicentro/api/conexiones/wordpress/WEBMAX530";
      images = [
  ...
  return (
    <>
      <Helmet>
        <title>
          {nombreCamion} - Venta de Cabezales {nombreSerie} en Ecuador -
          Vehicentro
        </title>
        ...
        <meta
          name="keywords"
          content={
            "cabezal, cabezales, venta de cabezales, cabezales en ecuador, cabezales en venta Ecuador , camiones en ecuador, camiones en venta Ecuador, venta cabezales Sinotruk, " +
            nombreCamion +
            ", " +
            nombreSerie +
            ", " +
        ...
        <meta
          property="og:url"
          content={"https://vehicentro.com/cabezales/" + pathUrl}
        ></meta>
      ...
      <div className="boxesIni posRelative content2">
        ...
        <div className="boxRight">
          ...
          {images.length == 1 && (
            <img
              src={images[0]}
              alt={`Portada ${nombreBusqueda}, ${nombreBusqueda2}`}
              title={`${nombreBusqueda}, ${nombreBusqueda2}`}
            />
          )}
        </div>
          ...
          <div className="boxText flex-table row textoSobrepuesto">
            <div className="escoderMovil">
              ...
              >
                <img
                  src={urlMedia + "arrow-rojo.png"}
                  alt={`Flecha ${nombreBusqueda}, ${nombreBusqueda2}`}
                  title={`${nombreBusqueda}, ${nombreBusqueda2}`}
                />
              </div>
            </div>
      ...
      <div className="contentProduct">
        <div className="marcasbg textoImagenesProducto">
          ...
          <div className="boxRightHeader  half icon_center">
            <div className="banner">
              <img
                src={tecnologia}
                alt={`Tecnologia ${nombreBusqueda}, ${nombreBusqueda2}`}
                title={`${nombreBusqueda}, ${nombreBusqueda2}`}
              />
            </div>
          </div>
          ...
          <div className="boxRightHeader  half icon_right">
            <div className="banner">
              <img
                src={garantia}
                alt={`Garantia ${nombreBusqueda}, ${nombreBusqueda2}`}
                title={`${nombreBusqueda}, ${nombreBusqueda2}`}
              />
            </div>
          </div>
        ...
        <div className="boxesIni posRelative partesbg">
          <div className="caracteristicasProductos">
            <img
              ...
              height="1000"
              className="slideMain"
              alt={`Caracteristicas ${nombreBusqueda}, ${nombreBusqueda2}`}
              title={`${nombreBusqueda}, ${nombreBusqueda2}`}
            />
          </div>
          ...
          <div className="caracteristicasProductos">
            <img
              ...
              height="1000"
              className="slideMain"
              alt={`Caracteristicas 2 ${nombreBusqueda}, ${nombreBusqueda2}`}
              title={`${nombreBusqueda}, ${nombreBusqueda2}`}
            />
          </div>
          ...
          <div className="caracteristicasProductos">
            <img
              ...
              height="1000"
              className="slideMain"
              alt={`Caracteristicas 3 ${nombreBusqueda}, ${nombreBusqueda2}`}
              title={`${nombreBusqueda}, ${nombreBusqueda2}`}
            />
          </div>
          ...
          <div className="caracteristicasProductos">
            <img
              ...
              height="1000"
              className="slideMain"
              alt={`Caracteristicas 4 ${nombreBusqueda}, ${nombreBusqueda2}`}
              title={`${nombreBusqueda}, ${nombreBusqueda2}`}
            />
          </div>
        </div>
        ...
        <div className="boxesIni posRelative">
          <div className="marcasbg">
            <img
              ...
              height="1500"
              className="slideMain"
              alt={`Cabina ${nombreBusqueda}, ${nombreBusqueda2}`}
              title={`${nombreBusqueda}, ${nombreBusqueda2}`}
            />
          </div>
        ...
        <div className="bannerMedidas noResponsive">
          <img
            src={medidas}
            alt={`Medidas ${nombreBusqueda}, ${nombreBusqueda2}`}
            title={`${nombreBusqueda}, ${nombreBusqueda2}`}
          />
        </div>
        <div className="bannerMedidas responsive">
          <img
            src={medidasMovil}
            alt={`Medidas Moviles ${nombreBusqueda}, ${nombreBusqueda2}`}
            title={`${nombreBusqueda}, ${nombreBusqueda2}`}
          />
        </div>
      </div>
      ...
      <div className="boxesIni posRelative">
        <div className="centrado">
          <img
            ...
            height="1000"
            className="slideMain"
            alt={`Postal ${nombreBusqueda}, ${nombreBusqueda2}`}
            title={`${nombreBusqueda}, ${nombreBusqueda2}`}
          />
        </div>
        <div>
