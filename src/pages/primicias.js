            ...
            <div>
                ...
                <div className="bottomContainer">
                    ...
                    <div className="linksBox">
                        <NavLink className="line2" to="/landing/primicias/camion/2-5-ton" >2.5 TON</NavLink>
                    </div>
                </div>
            </div>
            <div>
        ...
        <div className="block3 boxBlock row2">
            ...
            <div>
                ...
                <div className="bottomContainer">
                    ...
                    <div className="linksBox">
                        <a className="line2" src="" href="/landing/primicias/volqueta/volqueta-t5g-280">8-9 m3</a>
                        <a className="line2" src="" href="/landing/primicias/volqueta/volqueta-t7h-430">10-14 m3</a>
