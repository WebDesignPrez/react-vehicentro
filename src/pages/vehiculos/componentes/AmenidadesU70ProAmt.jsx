        ...
        <div className="option">
          <div className="uno">
            <div className="izquierda">
              <img
                src={urlMedia + "icono1.png"}
                alt="Asiento de Pasajeros Auto U70PRO"
              />
              <p>7 Pasajeros</p>
            </div>
            <div className="derecha">
              <img
                src={urlMedia + "icono2.png"}
                alt="Icono Motor U70PRO 154HP"
              />
              <p>154 HP</p>
            </div>
            <div className="izquierda">
          ...
          <div className="dos">
            <div className="izquierda2">
              <img
                className="suvCarro"
                src={urlMedia + "icono5.png"}
                alt="Largo del auto U70PRO"
              />
              <p>4825 mm</p>
            </div>
            <div className="derecha2">
              <img
                src={urlMedia + "icono6.png"}
                alt="Techo panorámico U70PRO"
              />
...
export default AmenidadesU70ProAmt;
