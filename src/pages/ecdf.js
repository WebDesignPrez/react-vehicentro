    ...
    function openFormContact(cam) {
        ...
        switch (cam) {
            ...
            case "cabezal-c7h-540-catalinas-48-toneladas-nueva-version":
                ...
                nombreSerie = "Serie C7H"
                bdc = "https://bdc.vehicentro.com:9443/ords/ws_vehicentro/api/conexiones/wordpress/LDECDF48TONCATNEW"
                ...
                <div>
                    ...
                    <div className="bottomContainer">
                        ...
                        <div className="linksBox">
                            <NavLink className="line2" to="/landing/ecdf/camion/2-5-ton" >NLS 2.5 TON</NavLink>
                            <p style={{ opacity: '30%' }}>|</p>
                            <NavLink className="line2" to="/landing/ecdf/camion/3-5-ton" ><span></span> NKS 3.5 TON ( LIVIANO )</NavLink>
                            <p style={{ opacity: '30%' }}>|</p>
                            <NavLink className="line2" to="/landing/ecdf/camion/camion-de-3-6-nks" ><span></span> NKS 3.6 TON ( PESADO )</NavLink>
                ...
                <div>
                    ...
                    <div className="bottomContainer">
                        ...
                        <div className="linksBox">
                            ...
                            <NavLink className="line2" to="/landing/ecdf/camion/5-ton">5 TON</NavLink><p style={{ opacity: '30%' }}>|</p>
                            <NavLink className="line2" to="/landing/ecdf/camion/6-ton">6 TON</NavLink><p style={{ opacity: '30%' }}>|</p>
                            <NavLink className="line2" to="/landing/ecdf/camion/8-ton">8 TON</NavLink>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div className="bottomContainer">
                        ...
                        <div className="linksBox">
                            <NavLink className="line2" to="/landing/ecdf/camion/9-ton">9 TON</NavLink><p style={{ opacity: '30%' }}>|</p>
                            <NavLink className="line2" to="/landing/ecdf/camion/10-ton">10 TON</NavLink><p style={{ opacity: '30%' }}>|</p>
                            <NavLink className="line2" to="/landing/ecdf/camion/12-ton">12 TON</NavLink><p style={{ opacity: '30%' }}>|</p>
                            <NavLink className="line2" to="/landing/ecdf/camion/13-ton">13 TON 280HP</NavLink><p style={{ opacity: '30%' }}>|</p>
                            <NavLink className="line2" to="/landing/ecdf/camion/13-ton-330">13 TON 330HP</NavLink><p style={{ opacity: '30%' }}>|</p>
                            <NavLink className="line2" to="/landing/ecdf/camion/18-ton">18 TON</NavLink><p style={{ opacity: '30%' }}>|</p>
                            <NavLink className="line2" to="/landing/ecdf/camion/19-ton">19.5 TON</NavLink><p style={{ opacity: '30%' }}>|</p>
                            <NavLink className="line2" to="/landing/ecdf/cabezal/24-ton">24 TON</NavLink>
            ...
            <div className="block3 boxBlock row2">
                <div>
                    ...
                    <div className="bottomContainer">
                        ...
                        <div className="linksBox">
                            <NavLink className="line2" to="/landing/ecdf/cabezal/28-ton">28 TON</NavLink><p style={{ opacity: '30%' }}>|</p>
                            <NavLink className="line2" to="/landing/ecdf/cabezal/cabezal-28-toneladas-retardador">28 ton - retardador</NavLink><p style={{ opacity: '30%' }}>|</p>
                            <NavLink className="line2" to="/landing/ecdf/cabezal/42-ton">42 TON</NavLink><p style={{ opacity: '30%' }}>|</p>
                            <NavLink className="line2" to="/landing/ecdf/cabezal/45-ton">45 TON</NavLink>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="bottomContainer">
                        ...
                        <div className="linksBox">
                            <NavLink className="line2" to="/landing/ecdf/camion/20-ton">20 TON</NavLink><p style={{ opacity: '30%' }}>|</p>
                            <NavLink className="line2" to="/landing/ecdf/camion/20-ton-catalinas">20 TON CATALINAS</NavLink><p style={{ opacity: '30%' }}>|</p>
                            <NavLink className="line2" to="/landing/ecdf/cabezal/48-ton">48 TON</NavLink><p style={{ opacity: '30%' }}>|</p>
                            <NavLink className="line2" to="/landing/ecdf/cabezal/48-ton-catalinas">48 TON CATALINAS</NavLink><p style={{ opacity: '30%' }}>|</p>
            ...
            <div className="block3 boxBlock row2">
                ...
                <div>
                    ...
                    <div className="bottomContainer">
                        ...
                        <div className="linksBox">
                            <a className="line2" src="" href="/landing/ecdf/volqueta/volqueta-t5g-280">T5G 8-9 m3</a><p style={{ opacity: '30%' }}>|</p>
                            <a className="line2" src="" href="/landing/ecdf/volqueta/volqueta-t7h-430">T7H 10-14 m3</a><p style={{ opacity: '30%' }}>|</p>
                            <a className="line2" href="/landing/ecdf/volqueta/volqueta-t7h-430-20m3">T7H 430 20 m3</a><p style={{ opacity: '30%' }}>|</p>
                            <a className="line2" href="/landing/ecdf/volqueta/volqueta-c7h-540">C7H 540 20 m3</a>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div className="bottomContainer">
                        ...
                        <div className="linksBox">
                            <a className="line2" src="" href="/landing/ecdf/mixer/mixer-a7-1257">A7 8-9 m3</a><p style={{ opacity: '30%' }}>|</p>
                            <a className="line2" src="" href="ecdf/mixer/mixer-12-14m3-c7h-430"> C7H 12-14 m3</a>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="bottomContainer">
                        ...
                        <div className="linksBox">
                            <NavLink className="line2" src="" to="/landing/ecdf/excavadora/swe210">EXCAVADORA SWE 210 21 Ton</NavLink><p style={{ opacity: '30%' }}>|</p>
                            <NavLink className="line2" src="" to="/landing/ecdf/excavadora/swe370e">EXCAVADORA SWE 370E 37 Ton Heavy Duty <span style={{ opacity: '30%' }}>|</span></NavLink>
                            <NavLink className="line2" src="" to="/landing/ecdf/minicargadoras/swl3220">MINICARGADORA SWL3220</NavLink>
                        </div>
                    </div>
