            ...
            <div className="block3 boxBlock row2">
                ...
                <div>
                    ...
                    <div className="bottomContainer">
                        ...
                        <div className="linksBox">
                            <a className="line2" src="" href="/landing/el-universo/excavadora/swe210">SW210 21 Ton</a>
                            <a className="line2" src="" href="/landing/el-universo/excavadora/swe370e">SW370E 37 Ton Heavy Duty</a>
                        </div>
                        <div className="linksBox">
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div className="bottomContainer">
                        ...
                        <div className="linksBox">
                            <a className="line2" src="" href="/landing/el-universo/minicargadoras/swl3220">SWL3220</a>
                        </div>
                        <div className="linksBox">
                        </div>
                    </div>
