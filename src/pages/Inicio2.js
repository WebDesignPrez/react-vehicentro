      ...
      <div className="block3 boxBlock" id="pagina">
        <div>
          ...
          <div className="bottomContainer">
            ...
            <NavLink className="titleBox2" to="/serie/n">
              N
            </NavLink>
            <div className="linksBox">
              <NavLink className="line2" to="/camiones/camion-de-2-5-toneladas">
                NLS 2.5 TON
              </NavLink>
              ...
              <NavLink
                ...
                to="/camiones/camion-de-3-5-toneladas-1057"
              >
                <span>NKS 3.5 TON ( LIVIANO )</span>
              </NavLink>
              <p style={{ opacity: "30%" }}>|</p>
              <NavLink className="line2" to="/camiones/camion-de-3-6-nks">
        ...
        <div>
          ...
          <div className="bottomContainer">
            <p className="titleBox">SERIE</p>
            <NavLink className="titleBox2" to="/serie/100">
              100
            </NavLink>
            <div className="linksBox">
              ...
              <NavLink
                className="line2"
                to="/camiones/camion-de-5-toneladas-1067"
              >
                5 TON
              </NavLink>
              <p style={{ opacity: "30%" }}>|</p>
              <NavLink
                className="line2"
                to="/camiones/camion-de-6-toneladas-1067"
              >
                6 TON
              </NavLink>
              <p style={{ opacity: "30%" }}>|</p>
              <NavLink className="line2" to="/camiones/camion-8-toneladas-1147">
                8 TON
              </NavLink>
            </div>
          </div>
        ...
        <div>
          <a href="/serie/t5g">
            <img
              src={urlMedia + "home/nuevasPortadas/serie-t5g.webp"}
              width="900"
              height="700"
              alt="Camiones de carga pesada en Ecuador"
            />
          ...
          <div className="bottomContainer">
            ...
            <div className="linksBox">
              <NavLink className="line2" to="/camiones/camion-de-9-toneladas">
                9 TON
              </NavLink>
              <p style={{ opacity: "30%" }}>|</p>
              <NavLink
                className="line2"
                to="/camiones/camion-10-toneladas-t5g-1167"
              >
                10 TON
              </NavLink>
              <p style={{ opacity: "30%" }}>|</p>
              <NavLink
                className="line2"
                to="/camiones/camion-12-toneladas-t5g-1167"
              >
                12 TON
              </NavLink>
              <p style={{ opacity: "30%" }}>|</p>
              <NavLink
                className="line2"
                to="/camiones/camion-13-toneladas-t5g-1167"
              >
                13 TON 280HP
              </NavLink>
              <p style={{ opacity: "30%" }}>|</p>
              <NavLink
                className="line2"
                to="/camiones/camion-13-toneladas-t5g-1167-330hp"
              >
                13 TON 330HP
              </NavLink>
              <p style={{ opacity: "30%" }}>|</p>
              ...
              <NavLink
                className="line2"
                to="/camiones/camion-de-19-toneladas-t5g-1257"
              >
                19.5 TON
              </NavLink>
              <p style={{ opacity: "30%" }}>|</p>
              <NavLink className="line2" to="/cabezales/cabezal-t5g-4187">
                24 TON
              </NavLink>
            </div>
          </div>
