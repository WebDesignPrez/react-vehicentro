      ...
      <div id="videoContainer">
        <div className="boxRight tecnologia" height="1080">
          <div className="boxLeft c7h">
            <video preload="none" autoPlay={true} width="930" height="1080" playsInline={true} controls loop muted id="myVideo" src="https://www.vehicentro.com/images/home/camionesM.mp4" className="videoWidth produ" />
          </div>
        </div>
...
function Block2() {
  return (
    <>        {/* < div className="block2 noResponsive" >
      ...
      < div className="block2 noResponsive" >
        <video preload="none" width="1920" height="1076" controls autoPlay={true} playsInline={true} muted loop src="https://www.vehicentro.com/images/home/u70proM2.mp4" className="videoWidth" /> ///////////
      </div >
    </>
