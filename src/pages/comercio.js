                ...
                <div>
                    ...
                    <div className="bottomContainer">
                        <div className="bannerTec">
                            <img src={urlMedia + "alemania_negro.webp"} width="590" height="170" alt="Tecnologia Alemana" />
                        </div>
            ...
            <div className="block3 boxBlock row2">
                ...
                <div>
                    ...
                    <div className="bottomContainer">
                        ...
                        <div className="linksBox">
                            <a className="line2" src="" href="/landing/comercio/excavadora/swe210">SW210 21 Ton</a>
                            <a className="line2" src="" href="/landing/comercio/excavadora/swe370e">SW370E 37 Ton Heavy Duty</a>
                        </div>
                        <div className="linksBox">
                        </div>
                    </div>
