...
function Camion() {
  ...
  switch (useParams("id").id) {
    ...
    case "volqueta-t5g-280":
      ...
      bdc =
        "https://bdc.vehicentro.com:9443/ords/ws_vehicentro/api/conexiones/wordpress/LDCOVOLQ89M3";
      images = [
        urlMedia +
          "volqueta-280/volqueta-blanca-sinotruk-de-venta-en-ecuador.webp",
        urlMedia +
          "volqueta-280/volqueta-blanca-de-frente-sinotruk-de-venta-en-ecuador.webp",
      ];
      textoMotor1 = "330 HP";
      ...
      precio = (
        <div className="banner">
          <img src={urlMedia + "volqueta-280/logo-sinotruk.webp"} />
        </div>
      );
      ...
      medidas =
        urlMedia +
        "volqueta-280/dimensiones-de-volqueta-de-8-9-m3-sinotruk.webp";
      medidasMovil =
        urlMedia +
        "volqueta-280/dimensiones-de-volqueta-de-8-9-m3-sinotruk-responsive.webp";
    ...
    case "volqueta-t7h-430":
      ...
      nombreSerie = "Especiales";
      bdc =
        "https://bdc.vehicentro.com:9443/ords/ws_vehicentro/api/conexiones/wordpress/LDCOVOLQ1014M3";
      images = [
        urlMedia +
          "volqueta-430/volqueta-blanca-sinotruk-de-venta-en-ecuador.webp",
      ];
      textoMotor1 = "430 HP";
      ...
      precio = (
        <div className="banner">
          <img src={urlMedia + "volqueta-430/logo-sinotruk.webp"} />
        </div>
      );
      ...
      medidas =
        urlMedia +
        "volqueta-430/dimensiones-de-volqueta-de-10-14-m3-sinotruk.webp";
      medidasMovil =
        urlMedia +
        "volqueta-430/dimensiones-de-volqueta-de-10-14-m3-sinotruk-responsive.webp";
    ...
    case "volqueta-c7h-540":
      ...
      images = [
        urlMedia +
          "volqueta-540/volqueta-blanca-sinotruk-de-venta-en-ecuador.webp",
      ];
      textoMotor1 = "22 m3";
      ...
      precio = (
        <div className="banner">
          <img src={urlMedia + "volqueta-540/logo-sinotruk.webp"} />
        </div>
      );
      ...
      medidas =
        urlMedia +
        "volqueta-540/dimensiones-de-volqueta-de-10-14-m3-sinotruk.webp";
      medidasMovil =
        urlMedia +
        "volqueta-540/dimensiones-de-volqueta-de-10-14-m3-sinotruk-responsive.webp";
      ...
      <div className="boxesIni posRelative content2">
        ...
        <div className="boxLeft playMotor contenedorTextoSobrepuesto">
          ...
          <div className="boxText flex-table row textoSobrepuesto">
            ...
            >
              <img src={urlMedia + "arrow-rojo.png"} alt="arrow" />
            </div>
        ...
        <div className="boxesIni posRelative">
          ...
          >
            ...
            >
              ...
              {internas1.length == 1 && <img src={internas1[0]} alt="" />}
            </div>
            <div
              className="boxRightHeader  half noResponsive"
              style={{ width: `50%` }}
            >
              ...
              {internas2.length == 1 && <img src={internas2[0]} alt="" />}
            </div>
            <div
            ...
            >
              ...
              {internas.length == 1 && <img src={internas[0]} alt="" />}
            </div>
            {contenedorMarcas}
          </div>
        </div>
