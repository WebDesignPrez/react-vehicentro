    ...
    return (
        <>
            <div className="boxesIni posRelative">
                ...
                <div>
                    <FormContact url="https://bdc.vehicentro.com:9443/ords/ws_vehicentro/api/conexiones/wordpress/WEBVHSERIEEXCAVADORA" camion={nombreCamion} serie="Excavadora" camionSerie={camionSerie} />
                </div>
            </div>
        </>
    )
